...
// ════════════════ المسار الأساسي ════════════════
{
  ...
  // ⚠️ النص العام اتغيّر 24 سبتمبر (البحث بقى بيشوف الأقدم) — الفحص لازم
  // يدوّر على النص **الحالي** وإلا بيعدّي على نص مش موجود أصلاً (درس 47)
  ok(cap.indexOf('للأقدم ابحث') < 0,
