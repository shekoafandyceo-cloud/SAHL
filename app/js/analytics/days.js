...
// نسبة التسليم بتظهر أول ما تبقى فيه شحنة محسومة (اتسلمت أو رجعت)،
// و«—» بس لو مفيش ولا واحدة اتحسمت — ووقتها جودة اليوم بتتحسب من
// التأكيد لوحده (rate.js/dayQuality). عدد اللي لسه في الشحن بيبان
// في الـtooltip.
//
...
export function renderDaysCalendar(){
  ...
  for(var day = 1; day <= daysInMonth; day++){
    ...
    // قرار المالك (4 أغسطس): النسبة تظهر عادي أول ما تبقى فيه شحنة محسومة.
    // الإخفاء لحد ما اليوم يخلص بالكامل كان بيخبّي أيام أغلبها محسوم فعلاً
    // (يوم فيه 19 من 25 محسومين كان بيظهر «—»). المقابل المقبول: يوم فيه
    // شحنة واحدة اتسلمت من 10 هيقول 100% ويتلوّن ممتاز — وعدد اللي لسه
    // ماشي موجود في الـtooltip.
